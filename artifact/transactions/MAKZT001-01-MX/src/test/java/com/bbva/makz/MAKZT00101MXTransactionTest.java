...
/**
 * Test for transaction MAKZT00101MXTransaction
 */
@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration(locations = {
		"classpath:/META-INF/spring/elara-test.xml",
		"classpath:/META-INF/spring/MAKZT00101MXTest.xml" })
public class MAKZT00101MXTransactionTest {
	private static final Logger LOGGER = LoggerFactory.getLogger(MAKZT00101MXTransactionTest.class);

	@Autowired
	private MAKZT00101MXTransaction transaction;
